...
public class SensorInput implements SensorEventListener {
    ...
    public SensorInput(TestExecutorActivity testExecutorActivity, TestExecutor testExecutor, Collector collector) {
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        m_collectorOwner.Amass(sensorEvent.values[0], sensorEvent.values[1], sensorEvent.values[2], System.currentTimeMillis());
    }
