...
public class ProgressWheel extends View {
    ...
    private int backgroundPaintColor = 0xFF000000;
    ...
    private Paint m_backgroundPaint = new Paint();
    ...
    private void setupPaints() {
        ...
        m_backgroundPaint.setColor(backgroundPaintColor);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float degreeRotate = (progress * 360)/ barLength;
        /*При делении возникает погрешность и он не дорисовывает*/
        if (progress == barLength){
            degreeRotate = 360;
        }
        //Draw the bar
        canvas.drawArc(circleBounds, -90, degreeRotate, false, barPaint);
